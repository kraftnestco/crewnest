...
export const BOOKING_BLOCK = [
  ...
  '1. When the customer wants to book, call check_availability with NO arguments. It returns which DAYS are free. Ask which day suits them, mentioning those days naturally. Do NOT mention any times yet.',
