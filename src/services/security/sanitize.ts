...
/**
 * Tool names the model must never mention to a customer. Kept here rather than
 * imported from the registry so this module stays dependency-free (it is
 * imported by the trigger-agnostic orchestrator).
 */
const TOOL_NAME_RE =
