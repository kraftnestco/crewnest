...
> what ClerkNest is, how to run + deploy, what's already shipped, the ordered remaining-work backlog,
...
at `clerknest-rouge.vercel.app` (Vercel + Supabase). The generic Next.js notes below are boilerplate.
